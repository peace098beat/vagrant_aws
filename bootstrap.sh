...
git clone https://github.com/peace098beat/keras_audio_cnn.git ~/keras_audio_cnn
...
mkdir ~/keras_audio_cnn/sairen+magna/mell_npy/
cp ~/*.npy ~/keras_audio_cnn/sairen+magna/mell_npy/
